...
negative_words = {
    ...
    'не дивиденд':0.7, 'дивидендов не':0.7, 'заблокирован':0.5, 'минимальная добыча':0.5
}
...
company_dict = {
    ...
    'nvtk': {'газ': 0.5, 'сжиженный природный газ': 0.7, 'ямал спг': 0.8},
    'gmkn': {'норильский никель': 0.7, 'палладий': 0.7, 'никель': 0.6, 'платина': 0.6},
    'tatn': {'нефть': 0.6, 'переработка': 0.5, 'добыча': 0.6},
    'mtss': {'телеком': 0.6, 'мобильные сервисы': 0.7, 'цифровые услуги': 0.8},
    'alrs': {'алмазы': 0.7, 'драгоценные камни': 0.6, 'добыча': 0.5},
    'sngs': {'газ': 0.7, 'нефть': 0.6, 'добыча': 0.5},
    'mvid': {'электроника': 0.6, 'ритейл': 0.5, 'бытовая техника': 0.6},
    'phor': {'удобрения': 0.7, 'фосфаты': 0.6, 'агрохимия': 0.7},
    'sibn': {'нефть': 0.6, 'банковский': 0.4, 'газпром нефть': 0.7},
    'afks': {'система': 0.5, 'функционирование': 0.5, 'холдинг': 0.6, 'инвестиции': 0.7},
    'magn': {'металлургия': 0.6, 'сталь': 0.7, 'прокат': 0.5},
    'lkoh': {'нефть': 0.7, 'добыча': 0.6, 'переработка': 0.5, 'экспорт': 0.6},
    'aflt': {'авиаперевозки': 0.5, 'авиакомпания': 0.4, 'пассажиры': 0.5, 'аэрофлот': 0.6},
    'cbom': {'банк': 0.5, 'кредитование': 0.6, 'московский кредитный банк': 0.7, 'финансы': 0.5},
    'posi': {'позитив': 0.8, 'кибербезопасность': 0.7, 'it': 0.8, 'программное обеспечение': 0.7},
    'plzl': {'золото': 0.8, 'добыча': 0.6, 'драгоценные металлы': 0.7, 'полюс': 0.7}
}
