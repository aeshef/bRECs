...
class TechAnalysisPipeline:
    def __init__(self,
        ...
        self.results = {}  # Будет хранить информацию по каждому тикеру
    ...
    def run_pipeline(self):
        ...
        # Определяем справочник параметров для индикаторов
        indicators_params = {
        ...
        for ticker in self.tickers:
            ...
            try:
                ...
                # Составляем сводку по индикаторам для этого тикера
                df = tech_pipeline.df
                # Определим "базовые" столбцы, которые были в исходных данных
                ...
                for col in df.columns:
                    if col not in base_columns:
                        ...
                        total = df.shape[0]
                        # Если есть информация о параметрах в справочнике, подставляем ее
                ...
                # Построение графика цены с индикаторами
